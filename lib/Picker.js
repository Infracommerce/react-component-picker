...
function InnerPicker(props) {
  ...
  React.useImperativeHandle(pickerRef, function () {
    var _pickerRef$current, _inputRef$current, _inputRef$current2;

    return {
      setViewDate: pickerRef === null || pickerRef === void 0 ? void 0 : (_pickerRef$current = pickerRef.current) === null || _pickerRef$current === void 0 ? void 0 : _pickerRef$current.setViewDate,
      focus: inputRef === null || inputRef === void 0 ? void 0 : (_inputRef$current = inputRef.current) === null || _inputRef$current === void 0 ? void 0 : _inputRef$current.focus,
      blur: inputRef === null || inputRef === void 0 ? void 0 : (_inputRef$current2 = inputRef.current) === null || _inputRef$current2 === void 0 ? void 0 : _inputRef$current2.blur
    };
  });
